...
sealed class Screen(val route: String) {
    ...
    object InstagramStoryViewer : Screen("instagram_story_viewer/{initialIndex}") {
        fun createRoute(initialIndex: Int) = "instagram_story_viewer/$initialIndex"
    }
}
...
internal fun getScreenOrderValue(screen: Screen): Int {
    return when (screen) {
        ...
        is Screen.InstagramStoryViewer -> 15
    }
}
